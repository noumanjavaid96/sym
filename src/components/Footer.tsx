      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center space-x-2 mb-4 logo-transition">
              <Zap className="h-6 w-6 text-primary-400" />
              <span className="text-xl font-bold text-white">Symflowise</span>
            </a>
            <p className="text-gray-400 mb-4 max-w-md">
              Next-generation AI contact center platform delivering exceptional customer experiences through intelligent automation and seamless integration.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Symflowise. All rights reserved.
            </p>
